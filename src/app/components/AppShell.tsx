...
export default function AppShell() {
  ...
  // H-01: Kite session expired banner state
  const [isKiteSessionExpired] = useState(false); // set true to test the banner
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-1.5 hover:bg-[#2a2a2a] px-2 py-1 rounded focus:outline-none">
                ...
                <span className="text-sm">{MOCK_USER.kiteUserId}</span>
              ...
              <DropdownMenuContent align="end" className="w-72 bg-[#1a1a1a] border-[#2a2a2a]">
                ...
                <div className="px-3 py-3 flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={`text-xs mt-1 flex items-center gap-1 ${MOCK_USER.kiteSessionActive ? "text-green-400" : "text-red-400"}`}>
                      <span className={`w-1.5 h-1.5 rounded-full ${MOCK_USER.kiteSessionActive ? "bg-green-400" : "bg-red-400"}`} />
                      {MOCK_USER.kiteSessionActive ? "Kite session active" : "Kite session expired"}
                    </p>
                    <p className="text-xs text-muted-foreground">
